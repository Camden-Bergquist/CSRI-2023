...
event_recorder <- function(tutorial_id, tutorial_version, user_id, event, data) {
  ...
  writeLines(paste(tutorial_id, tutorial_version, user_id, event, toString(data)), con)
...
question_numeric(
  ...
  answer(4460, correct = TRUE, message = "As of 2021, the approximate population of Mount Vernon is 4460."),
  tolerance = 100,
  step = 10,
  options = list(
